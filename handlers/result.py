...
class CommandResultGetHandlerThread(threading.Thread):
    ...
    def run(self):
        ...
        if self.uuid is None:
            ...
            self.final_dict[C.COMMAND_TABLE_TO] = command_attributes[C.COMMAND_TABLE_TO]
            self.final_dict[C.COMMAND_TABLE_TO_ID] = command_attributes[C.COMMAND_TABLE_TO_ID]
            self.final_dict['count'] = command.get_command_count(str(self.uuid))
