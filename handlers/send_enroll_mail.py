...
class MailSenderThread(threading.Thread):
    ...
    def run(self):
        ...
        msg = 'Your download link is.' + \
            str(self.link) + ' and enrollment password is ' + self.password
        ...
        try:
            ...
            print "Some Errors in sending the mail please check the email \
or the sender's configuration"
            self.error = 1
