...
class IosCommand(Engine):
    def execute(self, policy_dict, device_id, device_udid, *args, **kwargs):
        ...
        if policy_dict.has_key('action_command'):
            ios_mapped_policy = {policy_dict.get('action_command'): True}

        elif policy_dict.has_key('broadcast_command'):
        ...
        if broadcast_message and self.udid and self.message_token != 'None':
            # create wrapper
            wrapper = APNSNotificationWrapper('/opt/toppatch/assets/ios/ckProd.pem', True)
            ...
            if action.get('install_application'):
                ...
                if installed_apps_query and  installed_apps_query.get('result') and (
                        current_time - executed_time) < datetime.timedelta(
                                        minutes=15):
                ...
                if installed_apps:
                    ...
                    pre_install_apps = [x.get('Identifier') for x in installed_apps]
                    to_install_apps = [x.get('app_identifier') for x in policy_app_list]
    ...
    def save_ios_command(self, command_list):
        ...
        special_uuid_list = ['55555555-5555-5555-5555-555555555555'+device_id,
            '77777777-7777-7777-7777-777777777777'+ device_id,
            '2929292929-29292929-292929-292929-292929'+ device_id]
