...
vpn_dict = {'VpnType': "VPN Name (PPTP/L2TP/IPSec)", 'OverridePrimary': "Send All Trafic(true/false)",
 			...
 			'OnDemandEnabledDict': {'OnDemandAlways': ["Array of On demand always domain"],

 									'OnDemandNever': ["Array of On demand never domain"],

 									'OnDemandRetry': ["Array of On demand Establish if needed"]},

 			'Hybrid': "Use hybrid Authentication (true/false)", 'GroupName': "Group Name",
 			'SharedSecret': "Shared Secret", 'PromptPassword': "Prompt for Password (true/false)",
 			...
 			'ManualProxy': {'HTTPProxy': "Hostname or IP address", 'ProxyPassword': "Password",
 							'ProxyUsername': "Authentication", 'PortNumber': "Port"},
 			'AutomaticProxy': {'ProxyServerUrl': "Proxy Server URL"}
}